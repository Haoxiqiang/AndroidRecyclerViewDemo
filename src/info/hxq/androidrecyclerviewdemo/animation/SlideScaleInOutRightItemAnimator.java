 ...
 * the License. *****************************************************************************
 */
package info.hxq.androidrecyclerviewdemo.animation;
...
public class SlideScaleInOutRightItemAnimator extends BaseItemAnimator {
    ...
    protected void animateRemoveImpl(final RecyclerView.ViewHolder holder) {
        ...
        ViewCompat.animate(view).setDuration(getRemoveDuration()).scaleX(mEndScaleX)
                .scaleY(mEndScaleY).translationX(+mRecyclerView.getWidth())
