...
public class ParallaxRecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final float SCROLL_MULTIPLIER = 0.8f;
    ...
    public void setParallaxHeader(View header, final RecyclerView view) {
        mRecyclerView = view;
        mHeader = new HeaderRelativeWrapper(header.getContext());
    ...
    static class HeaderRelativeWrapper extends RelativeLayout {
